...
SOURCES= mDGmod.f90 mDGsweep.f90 ppmsweep_fct.f90 ppmsweep_pmod.f90 ppmwrap.f90 ppmsweep_pmod_clean_sl.f90 pcmsweep_semilagrangian.f90 tfcn.f90 
OBJECTS=$(SOURCES:.f90=.o)

all: $(SOURCES) test_skam_1d test_skam_2d

2d_test: test_skam_2d
	./test_skam_2d
